...
const api = 'AIzaSyC-ZJ7qv3d8-Bvo2KHVqX2GlZoy3nkoJak'
class App extends React.Component {
  ...
  searchVideo(queryString) {
    ...
    fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&key=${api}&q=${queryString}&type=video&videoEmbeddable=true`)
    .then((res)=>res.json())
    .then((data)=>{
      this.setState({
        isLoading: false,
